...
DD = Parameter(name = 'DD',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt(4*mST**2 + (-mS + mT)**2)',
               texname = '\\delta')
...
ST = Parameter(name = 'ST',
               nature = 'internal',
               type = 'real',
               value = '0.7071067811865476*cmath.sqrt(1 - (-mS + mT)/DD)',
               texname = '\\text{ST}')
...
C2T = Parameter(name = 'C2T',
                nature = 'internal',
                type = 'real',
                value = 'CT**2 - ST**2',
                texname = '\\text{C2T}')

S2T = Parameter(name = 'S2T',
                nature = 'internal',
                type = 'real',
                value = '2*CT*ST',
                texname = '\\text{S2T}')
